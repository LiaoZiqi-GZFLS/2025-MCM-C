...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{C_files/C_43_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{C_files/C_75_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{C_files/C_77_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\PY{c+c1}{\PYZsh{} 预测2028年的值}
\PY{n}{year\PYZus{}2028} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2028}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{pre\PYZus{}medal\PYZus{}2028} \PY{o}{=} \PY{n}{model\PYZus{}medal}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{year\PYZus{}2028}\PY{p}{)}
\PY{n}{pre\PYZus{}gold\PYZus{}2028} \PY{o}{=} \PY{n}{model\PYZus{}gold}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{year\PYZus{}2028}\PY{p}{)}
...
\PY{n}{year\PYZus{}2028\PYZus{}sm} \PY{o}{=} \PY{n}{sm}\PY{o}{.}\PY{n}{add\PYZus{}constant}\PY{p}{(}\PY{n}{year\PYZus{}2028}\PY{p}{)}  \PY{c+c1}{\PYZsh{} 添加常数项}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{fill\PYZus{}between}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2028}\PY{p}{]}\PY{p}{,} \PY{n}{pre\PYZus{}medal\PYZus{}2028\PYZus{}sm}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mean\PYZus{}ci\PYZus{}lower}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{pre\PYZus{}medal\PYZus{}2028\PYZus{}sm}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mean\PYZus{}ci\PYZus{}upper}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{red}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.2}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{fill\PYZus{}between}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2028}\PY{p}{]}\PY{p}{,} \PY{n}{pre\PYZus{}gold\PYZus{}2028\PYZus{}sm}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mean\PYZus{}ci\PYZus{}lower}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{pre\PYZus{}gold\PYZus{}2028\PYZus{}sm}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mean\PYZus{}ci\PYZus{}upper}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{green}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.2}\PY{p}{)}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{预测2028年首次获得奖牌的国家数量: }\PY{l+s+si}{\PYZob{}}\PY{n}{pre\PYZus{}medal\PYZus{}2028}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{l+s+si}{:}\PY{l+s+s2}{.2f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{预测2028年首次获得金牌的国家数量: }\PY{l+s+si}{\PYZob{}}\PY{n}{pre\PYZus{}gold\PYZus{}2028}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{l+s+si}{:}\PY{l+s+s2}{.2f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
